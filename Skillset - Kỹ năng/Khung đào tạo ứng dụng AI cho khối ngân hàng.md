...
### **BUỔI SÁNG (08:30 – 12:00): TƯ DUY NỀN TẢNG & CÔNG CỤ MÔ HÌNH HÓA**

| **Thời gian** | **Nội dung** | **Hoạt động & Ví dụ minh họa** | **Kết quả đầu ra** |
| :--- | :--- | :--- | :--- |
| **08:30 - 09:30** | **Module 1: AI - Cuộc Cách Mạng Mới Trong Ngành Tài Chính - Ngân Hàng**<br>- Giới thiệu Generative AI và sự khác biệt.<br>- Tại sao AI là kỹ năng bắt buộc cho Banker?<br>- Tư duy cốt lõi: Biến AI thành "Trợ lý ảo thông minh".<br>- **Nguyên tắc VÀNG**: Bảo mật và Tuân thủ. Phân biệt công cụ AI công cộng và nền tảng AI nội bộ an toàn của ngân hàng. | **Ví dụ minh họa thực tế:**<br>Thay vì mất vài ngày để thẩm định một khoản vay tiêu dùng nhỏ, ngân hàng có thể ứng dụng **AI Credit Scoring** để phân tích CIC, lịch sử giao dịch và hành vi của khách hàng. Kết quả là hồ sơ có thể được xử lý trong vài giờ, giảm chi phí thẩm định và tăng sự hài lòng của khách hàng.<br><br>**Bài tập thực hành: "Cờ Xanh / Cờ Đỏ" về Bảo mật**<br>Giảng viên đưa ra các yêu cầu, học viên giơ cờ Xanh (An toàn) hoặc cờ Đỏ (Tuyệt đối không).<br>- **Ví dụ Cờ Xanh:** "Hãy viết một email marketing giới thiệu sản phẩm thẻ tín dụng mới."<br>- **Ví dụ Cờ Đỏ:** "Tóm tắt file sao kê lương của khách hàng Nguyễn Văn A, số CCCD 0123456789, để tìm ra các khoản chi bất thường."<br>- **Thảo luận:** Tại sao thông tin ở ví dụ 2 là Cờ Đỏ và rủi ro nếu làm lộ lọt là gì? | - Học viên hiểu được ứng dụng cụ thể của AI trong việc tăng tốc nghiệp vụ.<br>- **Nắm rõ các quy tắc bảo mật**, có khả năng phân biệt thông tin nào là nhạy cảm và không được chia sẻ ra bên ngoài, bảo vệ cả khách hàng và ngân hàng. |
| **09:30 - 10:30** | **Module 2: "Nghệ thuật Giao việc cho AI" - Kỹ năng Prompt Engineering Cốt lõi**<br>- Cấu trúc một câu lệnh hiệu quả: **[Đóng vai] + [Bối cảnh] + [Nhiệm vụ] + [Định dạng]**.<br>- Nguyên tắc **"Tin tưởng nhưng phải xác minh"**: Luôn kiểm tra lại các thông tin quan trọng (số liệu, chính sách) mà AI cung cấp. | **Ví dụ minh họa thực tế:**<br>- **Prompt tệ:** "Viết email tư vấn khách hàng vay mua nhà."<br>- **Prompt tốt:** "Đóng vai chuyên viên khách hàng cá nhân tại Vietinbank Lào. Soạn một email tư vấn cho anh Somboun, thu nhập 30 triệu kip/tháng, về gói vay mua chung cư 800 triệu kip. Nhấn mạnh lãi suất ưu đãi 7.5%/năm và hồ sơ duyệt nhanh trong 48 giờ..."<br><br>**Bài tập thực hành: "Từ Mơ hồ đến Chính xác"**<br>1. **Bước 1 (Prompt Mơ hồ):** "So sánh sản phẩm thẻ tín dụng của chúng ta với đối thủ." -> Kết quả chung chung, sai lệch.<br>2. **Bước 2 (Tinh chỉnh & Cung cấp ngữ cảnh):** "Dựa vào file thông tin tôi cung cấp, hãy tạo bảng so sánh thẻ A và B theo tiêu chí: phí thường niên, lãi suất, hoàn tiền..."<br>3. **Bước 3 (Cross-check):** Yêu cầu học viên kiểm tra lại một thông tin "lạ" do AI tự bịa ra để nhấn mạnh tầm quan trọng của việc xác thực. | - Học viên có thể viết được những câu lệnh rõ ràng, chi tiết, cung cấp đủ ngữ cảnh để AI đưa ra kết quả mong muốn.<br>- **Nhận thức rõ AI có thể sai hoặc "tự bịa" thông tin (hallucination)**. Xây dựng thói quen luôn kiểm tra lại các thông tin quan trọng trước khi sử dụng. |
| **10:30 - 10:45** | **Nghỉ giải lao** | | |
|10:45 - 12:00|	Module 3: Tự Động Hóa Báo Cáo & Trình Bày Với AI<br>- Sử dụng AI để phân tích dữ liệu và tạo báo cáo nhanh.<br>- Ứng dụng AI để thiết kế slide thuyết trình từ nội dung cho trước.|	Thực hành 1: "AI Phân tích Dữ liệu"<br>1. Cung cấp dữ liệu: Giảng viên cung cấp một file Excel/bảng dữ liệu mẫu về kết quả kinh doanh (ví dụ: số lượng thẻ phát hành theo chi nhánh).<br>2. Ra lệnh: Học viên dùng ChatGPT (Advanced Data Analysis) với câu lệnh: "Phân tích dữ liệu kinh doanh này, nêu ra 3 chi nhánh có kết quả cao nhất và tạo biểu đồ cột so sánh."<br><br>Thực hành 2: "AI Thiết kế Slide"<br>1. Yêu cầu: "Dựa trên báo cáo phân tích vừa tạo, hãy tạo dàn bài chi tiết cho một buổi trình bày PowerPoint gồm 5 slide để báo cáo kết quả cho ban giám đốc. Nêu rõ tiêu đề và nội dung chính của từng slide."	|- Học viên có khả năng dùng AI để thực hiện phân tích dữ liệu cơ bản và trực quan hóa bằng biểu đồ.<br>- Nắm được cách biến một báo cáo hoặc dàn ý thành một bài trình bày có cấu trúc chỉ trong vài phút, tiết kiệm thời gian đáng kể.|


### **BUỔI CHIỀU (13:30 – 17:00): ỨNG DỤNG AI CHUYÊN SÂU THEO KHỐI NGHIỆP VỤ (THỰC HÀNH)**

| **Thời gian Timeline** | **Nội dung** | **Hoạt động & Ví dụ minh họa** | **Kết quả đầu ra** |
| :--- | :--- | :--- | :--- |
| **13:30 - 14:05** | **Thực hành Nhóm 1: Khối Bán Lẻ & Dịch Vụ Khách Hàng** | • **Thực hành "Trợ lý Cá nhân" với ChatGPT:**<br>  1. **Tư vấn & Bán chéo:** "Khách hàng A, thu nhập 15 triệu/tháng. Hãy tạo kịch bản tư vấn thẻ tín dụng B, nhấn mạnh lợi ích hoàn tiền mua sắm online. Sau đó, gợi ý 2 sản phẩm đi kèm phù hợp."<br>  2. **Xử lý khủng hoảng:** Soạn email gửi khách hàng với nội dung "Xin lỗi và khôi phục niềm tin khi xảy ra sự cố lỗi hệ thống", đảm bảo giọng văn chân thành, nhận trách nhiệm.<br>• **Giới thiệu "Giải pháp Chuyên sâu":** Demo Chatbot thông minh chăm sóc khách hàng 24/7, tự động trả lời các câu hỏi thường gặp và chuyển tiếp đến nhân viên khi cần. | - CBNV có thể tư vấn sản phẩm cá nhân hóa và xử lý tình huống khó một cách chuyên nghiệp.<br>- Giảm thời gian soạn thảo, tăng thời gian tương tác trực tiếp và bán chéo sản phẩm hiệu quả hơn. |
| **14:05 - 14:40** | **Thực hành Nhóm 2: Khối Quan Hệ Khách Hàng (Cá nhân & DN)** | • **Thực hành "Trợ lý Cá nhân" với ChatGPT:**<br>  1. **Phân tích khách hàng:** "Tóm tắt báo cáo tài chính của công ty ABC (mẫu). Nêu 3 điểm mạnh và 3 rủi ro tín dụng tiềm ẩn."<br>  2. **Chuẩn bị gặp gỡ:** "Tạo bản tóm tắt về ngành dệt may 6 tháng đầu năm (thách thức & cơ hội) để chuẩn bị họp với khách hàng."<br>  3. **Soạn thảo email:** Viết email thông báo phê duyệt khoản vay, thay đổi lãi suất, và email nhắc nợ đến hạn một cách nhẹ nhàng, lịch sự.<br>• **Giới thiệu "Giải pháp Chuyên sâu":** Demo Trợ lý ảo nội bộ FOXAI giúp tra cứu tức thì các quy định, chính sách sản phẩm, biểu phí. | - RM nhanh chóng nắm bắt "sức khỏe" doanh nghiệp và thông tin ngành.<br>- Tăng tốc độ chuẩn bị hồ sơ, đề xuất tín dụng và các buổi gặp gỡ khách hàng, nâng cao sự chuyên nghiệp. |
| **14:40 - 15:15** | **Thực hành Nhóm 3: Khối Marketing & Quản Trị Thương Hiệu** | • **Thực hành "Trợ lý Cá nhân" với Gemini:**<br>  1. **Sáng tạo nội dung:** "Viết 5 tiêu đề hấp dẫn cho bài đăng Facebook/TikTok giới thiệu chương trình khuyến mãi cuối năm."<br>  2. **Lên ý tưởng hình ảnh/video:** "Đề xuất 3 ý tưởng hình ảnh và 1 kịch bản video ngắn 15 giây để quảng bá sản phẩm thẻ cho người trẻ."<br>• **Giới thiệu "Giải pháp Chuyên sâu":** Trình bày Dịch vụ Digital Marketing FOXAI (đo lường hiệu quả dựa trên tăng trưởng doanh thu). | - Đội ngũ marketing có thể nhanh chóng tạo ra nhiều ý tưởng nội dung sáng tạo, bắt trend.<br>- Rút ngắn thời gian lên kế hoạch và triển khai các chiến dịch truyền thông đa kênh. |
| **15:15 - 15:30** | **Nghỉ giải lao** | | |
| **15:30 - 16:05** | **Thực hành Nhóm 4: Khối Kế Toán & Back-Office** | • **Thực hành "Trợ lý Cá nhân":**<br>  1. **Đối soát dữ liệu:** Dùng ChatGPT để so sánh 2 file excel trích xuất từ hệ thống Mobile và Core Banking, tìm ra các mã giao dịch chênh lệch.<br>  2. **Thư ký AI:** Dùng NotebookLM để ghi âm và tự động tạo biên bản tóm tắt nội dung cuộc họp phòng.<br>• **Giới thiệu "Giải pháp Chuyên sâu":** Demo công cụ FOXAI Native tự động quét, nhận dạng và nhập liệu hóa đơn, chứng từ vào phần mềm Core. | - Giảm thiểu sai sót và thời gian trong công tác đối soát thủ công.<br>- Tự động hóa việc ghi chép và lưu trữ thông tin cuộc họp, tăng hiệu suất làm việc. |
| **16:05 - 16:40** | **Thực hành Nhóm 5: Khối Quản Lý Rủi Ro & Tuân Thủ**<br><br>**Phần 1: AI Hỗ trợ Tuân thủ**<br>- Ứng dụng AI trong việc tóm tắt văn bản pháp quy và xây dựng công cụ kiểm soát.<br><br>**Phần 2: Ứng Dụng AI/ML Trong Việc Dự Báo & Xây Dựng Mô Hình**<br>- Giới thiệu khái niệm Học máy: "Dạy" máy tính học từ dữ liệu quá khứ để dự đoán tương lai.<br>- Tập trung vào mô hình cụ thể: **Dự báo khách hàng rời bỏ (Churn Prediction).** | **Hoạt động 1: Thực hành "Trợ lý Tuân thủ" với ChatGPT**<br>1. **Tóm tắt quy định:** "Tóm tắt Thông tư [số] của NHNN về các yêu cầu an toàn vốn. Liệt kê 5 điểm chính mà phòng ban cần tuân thủ."<br>2. **Xây dựng checklist:** "Tạo một checklist chi tiết để kiểm tra quy trình mở tài khoản KYC tại chi nhánh, đảm bảo tuân thủ quy định phòng chống rửa tiền."<br><br>**Hoạt động 2: "Trải nghiệm chạy mô hình dự báo rủi ro"**<br>1. **Chuẩn bị:** Giảng viên cung cấp link đến công cụ demo có sẵn mô hình **Churn Prediction**.<br>2. **Nhập liệu:** Học viên được cung cấp thông tin của 2 khách hàng giả lập:<br>   - **KH A:** Giao dịch ổn định, số dư tăng.<br>   - **KH B:** 3 tháng gần đây số dư giảm 70%, vừa tất toán sổ tiết kiệm.<br>3. **Xem kết quả:** Học viên nhập chỉ số của 2 KH vào công cụ. Mô hình trả về dự báo: "KH A: Rủi ro rời bỏ 10% - An toàn", "KH B: Rủi ro rời bỏ 85% - Cảnh báo cao".<br>4. **Thảo luận:** "Tại sao mô hình lại đưa ra kết quả như vậy? Với cảnh báo của KH B, bộ phận Quản lý Rủi ro và Bán lẻ nên có hành động phối hợp gì ngay lập tức?" | - Chuyên viên có thể cập nhật, phân tích quy định và xây dựng công cụ kiểm soát nhanh hơn.<br>- **Hiểu được cách một mô hình AI/ML hoạt động ở mức độ cơ bản**: nhận dữ liệu đầu vào, phân tích và đưa ra kết quả dự báo có ý nghĩa.<br>- Thấy được giá trị thực tiễn của mô hình trong việc chuyển từ quản lý rủi ro bị động (sự cố xảy ra rồi mới xử lý) sang **chủ động** (phát hiện và hành động trước khi rủi ro xảy ra). |
| **16:40 - 17:00** | **Tổng kết, Hỏi & Đáp** | - Giảng viên giải đáp các thắc mắc chung.<br>- Tóm tắt các kiến thức cốt lõi và khuyến khích học viên tiếp tục ứng dụng. | - Giải đáp toàn bộ vướng mắc, củng cố kiến thức và tạo động lực thực hành sau khóa học. |
...
- ChatGPT hỗ trợ tạo kịch bản chăm sóc KH, gửi email "Xin lỗi khách hàng và mong muốn khôi phục niềm tin khi xảy ra lỗi hệ thống"
- Chuyên sâu: Chatbot chăm sóc KH 24/7

2.Khối Quan hệ khách hàng (DN, cá nhân):
- ChatGPT hỗ trợ phân tích báo cáo tài chính của DN, tạo kịch bản chào hàng; Email thông báo KH về việc phê duyệt khoản vay - thay đổi lãi suất; Email nhắc nợ đến hạn - thu hồi nợ nhẹ nhàng.
- Chuyên sâu: Trợ lý ảo nội bộ FOXAI

3.Khối marketing và quản trị thương hiệu

- Gemini hỗ trợ tạo hình ảnh, video, chiến dịch marketing
- Chuyên sâu: Dịch vụ Digital Marketing FOXAI

4.Khối kế toán và Back-office:

- ChatGPT đối soát dữ liệu giao dịch giữa 2 phần mềm Mobile và Core; NotebookLM thư ký AI ghi biên bản cuộc họp
- Chuyên sâu: FOXAI Native tự động nhập liệu hóa đơn/chứng từ vào phần mềm Core

5.Khối quản lý rủi ro

- ChatGPT: Tóm tắt văn bản QPPL, thông tư hướng dẫn của ngân hàng nhà nước
